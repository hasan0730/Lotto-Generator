...
<body>
 ...
 <p><a style="text-decoration:none" href="lotto_allornothing.php">[Generate All or Nothing]</a>&nbsp;&nbsp;<a style="text-decoration:none" href="lotto_cash5.php">[Generate Cash 5]</a>&nbsp;&nbsp;<a style="text-decoration:none" href="lotto_powerball.php">[Generate Power Ball]</a></p>
<p><a style="text-decoration:none" href="lotto_megamillions.php">[Generate Mega Millions]</a>&nbsp;&nbsp;<a style="text-decoration:none" href="lotto_texaslotto.php">[Generate Texas Lotto]</a>&nbsp;&nbsp;<a style="text-decoration:none" href="lotto_texastwostep.php">[Generate Texas Two Step]</a></p>
 ...
 $setSize = 4;						 // Number of lucky numbers in the set.  
 $setRange = 35;					 // Assume selecting integers between 1 and range.  
   ...
   while($luckyCount < $setSize) {  
	...
	switch ($luckyCount){
	 ...
	 if ($luckyCount == 4){  
	       ...
	       echo "<p><strong>Texas Two Step: </strong> " .$luckyArray[0] . " ".  $luckyArray[1]  ." ".$luckyArray[2]. " ".$luckyArray[3]." "."<strong>Bouns Ball:</strong> ".rand(1,35) ."</p>";
	   }
